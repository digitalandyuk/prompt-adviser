...
- Jev was not called. The packaged OpenRouter helper was checked without sending a request. No `OPENROUTER_API_KEY` is available in this Codex process. A live trial needs an OpenRouter key, available account credit and approval for the specific state transmitted.
